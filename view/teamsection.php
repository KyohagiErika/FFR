        ...
        <div class="flex flex-wrap justify-center -mx-4">
            <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                <div class="mb-10 wow fadeInUp" data-wow-delay=".1s">
                    ...
                    >
                        <img src="./images/team/team-01.png" alt="image"
            ...
            <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                <div class="mb-10 wow fadeInUp" data-wow-delay=".15s">
                    <div
                        class="relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6"
                    >
                        <img src="./images/team/team-02.png alt="image"
                        class="w-full rounded-full"
                        />
                        <span class="absolute top-0 left-0 z-[-1]">
                <svg
            ...
            <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                <div class="mb-10 wow fadeInUp" data-wow-delay=".2s">
                    <div
                        class="relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6"
                    >
                        <img src="./images/team/team-03.png" alt="image"
                             class="w-full rounded-full"
                        />
                        <span class="absolute top-0 left-0 z-[-1]">
                <svg
                  ...
                  />
                    ...
                    <div class="text-center">
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <a href="javascript:void(0)"
                               class="text-[#cdced6] hover:text-primary w- h-8 mx-2flex items-center justify-center"
                            >
                                <svg
                                    width="18"
                                    height="14"
