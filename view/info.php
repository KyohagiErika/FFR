                        ...
                        <div class="flex flex-wrap items-center p-4 sm:p-8 pb-4">
                            <div class="flex items-center mb-4 mr-5 md:mr-10">
                                <div class="w-10 h-10 rounded-full overflow-hidden mr-4">
                                    <img
                                        src="./images/blog/author-01.png" alt="image"
                                        class="w-full"
                                    />
                                </div>
                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full lg:w-8/12 px-4">
                        <div>
                            ...
                            <p class=" text-base text-body-color leading-relaxed mb-8 wow fadeInUp"
                                data-wow-delay=".1s"
                            >
                            ...
                            <p class=" text-base text-body-color leading-relaxed mb-10 wow fadeInUp"
                                data-wow-delay=".1s"
                            >
                                There's a time and place for everything… including asking
                                for reviews. For instance: you should not asking for a
                      ...
                      <span class="absolute left-0 top-0">
                        ...
                        >
                          ...
                          <defs>
                            ...
                            <p class=" text-base text-body-color leading-relaxed mb-8 wowfadeInUp"
                                data-wow-delay=".1s"
                            >
                                At quo cetero fastidii. Usu ex ornatus corpora sententiae,
                                vocibus deleniti ut nec. Ut enim eripuit eligendi est, in
                            ...
                            <p class=" text-base text-body-color leading-relaxed mb-11 wow fadeInUp"
                                data-wow-delay=".1s"
                            >
                                At quo cetero fastidii. Usu ex ornatus corpora sententiae,
                                vocibus deleniti ut nec. Ut enim eripuit eligendi est, in
                            ...
                            <div class="flex flex-wrap items-center -mx-4 mb-12">
                                <div class="w-full md:w-1/2 px-4">
                                    <div class=" flex items-center flex-wrap mb-8 md:mb-0 wow fadeInUp"
                                        data-wow-delay=".1s"
                                    >
                                        <a href="javascript:void(0)"
                                            class=" block py-2 px-5 bg-primary bg-opacity-5 text-primary rounded text-xs font-medium mr-2 md:mr-4  lg:mr-2 xl:mr-4 mb-2 hover:bg-opacity-100 hover:text-white"
                                        >
                                            Design
                                        </a>
                                        <a href="javascript:void(0)"
                                        ...
                                        <a href="javascript:void(0)"
                                            class="  block py-2 px-5 mb-2  bg-primary bg-opacity-5 text-primary rounded text-xs font-medium hover:bg-opacity-100 hover:text-white"
                                        >
                                            Info
                                        </a>
                                    </div>
