            ...
            <div class="w-full px-4">
                ...
                >
                    ...
                    <ul class="flex flex-wrap items-center justify-center mb-10">
                        <li>
                            <a href="https://links.tailgrids.com/play-download"
                               class="py-4 px-6 sm:px-10 inline-flex items-center justify-center text-center text-dark text-base bg-white hover:text-primary hover:shadow-lg
                    ...
                    <div class="text-center wow fadeInUp" data-wow-delay=".3s">
                        <img src="./images/hero/brand.svg" alt="image"
    ...
    <div class="container">
        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full md:w-1/2 lg:w-1/4 px-4">
              ...
              <span
                      class="w-[70px] h-[70px] flex items-center justify-center bg-primary bg-opacity-20 rounded-2xl mb-8 absolute z-[-1] top-0 left-0
                rotate-[25deg] group-hover:rotate-45 duration-300"
              ></span>
                        <svg
                                width="35"
                                height="35"
