        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 px-4">
                <div class="w-full mb-10">
                    ...
                    <ul>
                        <li>
                            <a href="javascript:void(0)" class="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                                Home
                            </a>
                        </li>
                        <li>
            ...
            <div class="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
                <div class="w-full mb-10">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="javascript:void(0)" cclass=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 ">
                                Ecommerce HTML
                            </a>
                        </li>
                        <li>
